...
class MealItem extends StatelessWidget{
 ...
 String get affordabilityText{
  ...
  @override
    ...
    ),// its different from column in the way ,
    //that in this type the widgets are rendered above each other i.e. you want set an image as backround and show other widgets on top of it
